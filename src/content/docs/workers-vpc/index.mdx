...
You can also use [VPC Network bindings](/workers-vpc/configuration/vpc-networks/) to give Workers broader access to your private infrastructure, including services behind [Cloudflare Mesh](/cloudflare-one/networks/connectors/cloudflare-mesh/) and destinations connected through [Cloudflare WAN](/cloudflare-wan/) on-ramps (GRE, IPsec, and CNI).
